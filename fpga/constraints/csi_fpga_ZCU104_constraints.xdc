# ------------------------------------------------------------------------------
# marian_fpga_VCU118_constraints.xdc
#
...
#create_clock -period 3.333 -name csi_clk_300M [get_ports pixel_clk_i]; # 300MHz
#create_clock -period 5.000 -name dphy_clk_200M [get_ports rx_byte_clk_hs_0]
#create_clock -period 20 -name axi_clk_50M [get_ports AXIS_ACLK]; # 50MHz
##
### Do not time asynchrous IO paths
#set_false_path -from [get_ports reset_n_i];
#set_false_path -from [get_ports axi_reset_n_i];
## RESET SYNCH
#create_clock -name dphy_byte_clk [get_nets *rx_byte_clk_hs*]
#create_clock -name dphy_cont_clk [get_nets *byte_clock_int*]
#######set_clock_groups -physically_exclusive -group [get_clocks rx_mipi_phy_if_0_clk_p_FIFO_WRCLK_OUT] -group [get_clocks clk_out3_design_1_clk_wiz_0_0]
## CDC
set_property DONT_TOUCH true [get_cells -hier {*cdc_reset_ctrlr* *cdc_reset_ctrlr_half* *i_src *i_dst *cdc_fifo_i *dphy_fifo_i}]
set_property KEEP_HIERARCHY true [get_cells -hier {*cdc_reset_ctrlr* *cdc_reset_ctrlr_half* *i_src *i_dst *cdc_fifo_i *dphy_fifo_i}]
#current_instance
######current_instance design_1_i/top_csi_fpga_wrapper_0/inst/top_csi_fpga_wrapper_sv_i/mipi_camera_processor_fpga_i/csi_integration_i/dphy_fifo_i
######set _xlnx_shared_i0 [get_pins -hierarchical {*async_*_o* *async_*_i*}]
######set_max_delay -through $_xlnx_shared_i0 5.555
######set_false_path -hold -through $_xlnx_shared_i0
#current_instance design_1_i/top_csi_fpga_wrapper_0/inst/top_csi_fpga_wrapper_sv_i/mipi_camera_processor_i/isp_pipeline_i
current_instance {design_1_i/top_csi_fpga_wrapper_0/inst/top_csi_fpga_wrapper_sv_i/mipi_camera_processor_fpga_i/isp_pipeline_i/isp_gen[0].flow_control_i/cdc_fifo_i}
set _xlnx_shared_i0 [get_pins -hierarchical {*async_*_o* *async_*_i*}]
set_max_delay -through $_xlnx_shared_i0 3.333
set_false_path -hold -through $_xlnx_shared_i0
####set_hierarchy_separator |
####current_instance
####current_instance design_1_i|top_csi_fpga_wrapper_0|inst|top_csi_fpga_wrapper_sv_i|mipi_camera_processor_i|isp_pipeline_i|isp_gen[0].flow_control_i
####set_max_delay 3.333 -through [get_pins -hierarchical {*i_src|Q *i_src|rptr_q_reg* *i_src|reg_q_reg[2]*}]
####set_false_path -hold -through [get_pins -hierarchical {*i_src|Q *i_src|rptr_q_reg* *i_src|reg_q_reg[2]*}]
##current_instance top_csi_fpga_wrapper_sv_i|mipi_camera_processor_i|isp_pipeline_i|isp_gen[0].flow_control_i|cdc_fifo_i
##set_max_delay 3.333 -through [get_pins -hierarchical -filter name=~*async*] -through [get_pins -hierarchical -filter name=~*async*]
##set_false_path -hold -through [get_pins -hierarchical -filter name=~*async*]  -through [get_pins -hierarchical -filter name=~*async*]
##current_instance
#current_instance top_csi_fpga_wrapper_sv_i|mipi_camera_processor_i|isp_pipeline_i|isp_gen[1].flow_control_i|cdc_fifo_i
#set_max_delay 3.333 -through [get_pins -hierarchical -filter name=~*async*] -through [get_pins -hierarchical -filter name=~*async*]
#set_false_path -hold -through [get_pins -hierarchical -filter name=~*async*]  -through [get_pins -hierarchical -filter name=~*async*]
#current_instance
#current_instance top_csi_fpga_wrapper_sv_i|mipi_camera_processor_i|isp_pipeline_i|isp_gen[2].flow_control_i|cdc_fifo_i
#set_max_delay 3.333 -through [get_pins -hierarchical -filter name=~*async*] -through [get_pins -hierarchical -filter name=~*async*]
#set_false_path -hold -through [get_pins -hierarchical -filter name=~*async*]  -through [get_pins -hierarchical -filter name=~*async*]
#current_instance
#current_instance top_csi_fpga_wrapper_sv_i|mipi_camera_processor_i|isp_pipeline_i|isp_gen[3].flow_control_i|cdc_fifo_i
#set_max_delay 3.333 -through [get_pins -hierarchical -filter name=~*async*] -through [get_pins -hierarchical -filter name=~*async*]
#set_false_path -hold -through [get_pins -hierarchical -filter name=~*async*]  -through [get_pins -hierarchical -filter name=~*async*]
...
#set_clock_groups -asynchronous #  -group [get_clocks -of_objects [get_pins i_top_clock/inst/plle4_adv_inst/CLKOUT0]] #  -group {jtag_tck}
...
#
# sensor_iic_scl_io  B9  HPC0_LA26_P  D26  FMC_SCL
# sensor_iic_sda_io  B8  HPC0_LA26_N  D27  FMC_SDA
#
current_instance -quiet
set_property PACKAGE_PIN B9 [get_ports IIC_0_scl_io]
...
set_property IOSTANDARD HSUL_12_DCI [get_ports IIC_0_*]
#set_property DRIVE 8 [get_ports {IIC_0_*}]
#
...
## CLK -------------------------------------------------------------------------
#set_property -dict {PACKAGE_PIN E12 IOSTANDARD DIFF_SSTL12} [get_ports clk_p_i]; # "250MHZ_CLK1_P"
#set_property -dict {PACKAGE_PIN D12 IOSTANDARD DIFF_SSTL12} [get_ports clk_n_i]; # "250MHZ_CLK1_N"
#set_property -dict {PACKAGE_PIN R24 IOSTANDARD LVCMOS18} [get_ports pixel_clk_i]; # "90MHZ_CLK"

## RESET -----------------------------------------------------------------------
#set_property -dict {PACKAGE_PIN M11 IOSTANDARD LVCMOS33} [get_ports reset_n_i]; # "CPU_RESET"

## Dont touch ------------------------------------------------------------------------
#set_property DONT_TOUCH true [get_nets rx_byte_clk_hs*]
#set_property DONT_TOUCH true [get_nets rx_valid_hs*]
#set_property DONT_TOUCH true [get_nets rx_data_hs*]
...
#-------------------------------------------------------------------------------
# Clock
#set_property -dict {PACKAGE_PIN E23 IOSTANDARD LVDS} [get_ports clk_125_n]; # Bank  28 VCCO - VCC1V8 - IO_L13N_T2L_N1_GC_QBC_28
#set_property -dict {PACKAGE_PIN F23 IOSTANDARD LVDS} [get_ports clk_125_p]; # Bank  28 VCCO - VCC1V8 - IO_L13P_T2L_N0_GC_QBC_28

# Reset
#set_property -dict {PACKAGE_PIN M11 IOSTANDARD LVCMOS33} [get_ports BTN_N]; # Bank  87 VCCO - VCC3V3 - IO_L4N_AD8N_87

# LED output
#set_property -dict {PACKAGE_PIN D5 IOSTANDARD LVCMOS33} [get_ports LEDG_N]; # Bank  88 VCCO - VCC3V3 - IO_L11N_AD9N_88

# DVI Interface
#set_property -dict {PACKAGE_PIN G8 IOSTANDARD LVCMOS33} [get_ports P1A1]; # Bank  87 VCCO - VCC3V3 - IO_L12N_AD0N_87
#set_property -dict {PACKAGE_PIN H8 IOSTANDARD LVCMOS33} [get_ports P1A2]; # Bank  87 VCCO - VCC3V3 - IO_L12P_AD0P_87
#set_property -dict {PACKAGE_PIN G7 IOSTANDARD LVCMOS33} [get_ports P1A3]; # Bank  87 VCCO - VCC3V3 - IO_L11N_AD1N_87
#set_property -dict {PACKAGE_PIN H7 IOSTANDARD LVCMOS33} [get_ports P1A4]; # Bank  87 VCCO - VCC3V3 - IO_L11P_AD1P_87
#set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS33} [get_ports P1A7]; # Bank  87 VCCO - VCC3V3 - IO_L10N_AD2N_87
#set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports P1A8]; # Bank  87 VCCO - VCC3V3 - IO_L10P_AD2P_87
#set_property -dict {PACKAGE_PIN J6 IOSTANDARD LVCMOS33} [get_ports P1A9]; # Bank  87 VCCO - VCC3V3 - IO_L9N_AD3N_87
#set_property -dict {PACKAGE_PIN J7 IOSTANDARD LVCMOS33} [get_ports P1A10]; # Bank  87 VCCO - VCC3V3 - IO_L9P_AD3P_87

# Ensure that IOB registers are used for data lines
#set_property IOB TRUE [get_ports P1A1 ]; # g_r
#set_property IOB TRUE [get_ports P1A3 ]; # vga_hs_r
#set_property IOB TRUE [get_ports P1A4 ]; # int_r
#set_property IOB TRUE [get_ports P1A7 ]; # r_r
#set_property IOB TRUE [get_ports P1A8 ]; # b_r
#set_property IOB TRUE [get_ports P1A9 ]; # vga_de_r
#set_property IOB TRUE [get_ports P1A10]; # vga_vs_r

# ignore untimed paths
#set_false_path -from [get_ports BTN_N ]; # reset
#set_false_path -to   [get_ports LEDG_N]; # LED0

# generated clock constraints
#create_generated_clock -name IDCK_p -source [get_pins "i_oddre/C"] -multiply_by 1 -invert #  [get_ports P1A2];

# set output max setup delay
#set_output_delay -clock IDCK_p -max 1.2 [get_ports P1A1 ]; # g_r
#set_output_delay -clock IDCK_p -max 1.2 [get_ports P1A3 ]; # vga_hs_r
#set_output_delay -clock IDCK_p -max 1.2 [get_ports P1A4 ]; # int_r
#set_output_delay -clock IDCK_p -max 1.2 [get_ports P1A7 ]; # r_r
#set_output_delay -clock IDCK_p -max 1.2 [get_ports P1A8 ]; # b_r
#set_output_delay -clock IDCK_p -max 1.2 [get_ports P1A9 ]; # vga_de_r
#set_output_delay -clock IDCK_p -max 1.2 [get_ports P1A10]; # vga_vs_r

# set output min hold delay
#set_output_delay -clock IDCK_p -min -1.3 [get_ports P1A1 ]; # g_r
#set_output_delay -clock IDCK_p -min -1.3 [get_ports P1A3 ]; # vga_hs_r
#set_output_delay -clock IDCK_p -min -1.3 [get_ports P1A4 ]; # int_r
#set_output_delay -clock IDCK_p -min -1.3 [get_ports P1A7 ]; # r_r
#set_output_delay -clock IDCK_p -min -1.3 [get_ports P1A8 ]; # b_r
#set_output_delay -clock IDCK_p -min -1.3 [get_ports P1A9 ]; # vga_de_r
#set_output_delay -clock IDCK_p -min -1.3 [get_ports P1A10]; # vga_vs_r
