...
module axi_xbar_128_wrapper (
  ...
  // marian m
  assign m_axi_awid_arr_s    [MIdxMarian] = marian_m_axi_req_i.aw.id;
  ...
  assign m_axi_arid_arr_s    [MIdxMarian] = marian_m_axi_req_i.ar.id;
  ...
  assign marian_m_axi_resp_o.b.id     = m_axi_bid_arr_s     [MIdxMarian];
  ...
  assign marian_m_axi_resp_o.r.id     = m_axi_rid_arr_s     [MIdxMarian];
